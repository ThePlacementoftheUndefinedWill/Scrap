...
<div class="row mt-5">
    <div class="col-lg-5 col-md-12 col-12">
        ...
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/T-shert4/R4.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/T-shert4/blue1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/T-shert4/blue2.webp" width="100%" class="small-img" alt="">
            </div>
    ...
    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Attract Soul Heart Ring
        </h2>
        <h6>home/Rings</h6>
        <h3>$400.00</h3>
        <select class="my-3">
        ...
        <span>This rhodium-plated AM-Shop ring is inspired by the idea of two hearts meeting. It captures the spirit of romance with two heart-shaped, finely cut stones meeting in the middle. The glittering white of the hearts is all the more accentuated by a simple, yet elegant design. Its timeless symbolism makes this Swarovski ring the perfect gift for a special loved one.</span>
    </div>
</div>
<div>
