    ...
    <div class="col-lg-5 col-md-12 col-12">
        ...
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/watches1/N1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches1/1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches1/2.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches1/3.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Swarovski Symbolic Necklace
        </h2>
...
<span>Taking its cues straight from the catwalk, this on-trend charm necklace is championing 2019's 'more is more' mantra. The rose-gold tone plated design has a choker-style silhouette and features seven different symbols, including a lucky horseshoe, an infinity sign, a hamsa hand, and an evil eye. Full of protective meaning, it sparkles in an array of tones and crystal settings. A statement piece, which will add fashionable flair to your look, day and night. Pair with the matching charm bracelet to go ultra boho.</span></div>
<div>
