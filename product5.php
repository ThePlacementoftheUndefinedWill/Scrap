...
<div class="row mt-5">
    <div class="col-lg-5 col-md-12 col-12">
        <img class="img-fluid w-100 pb-1" src="img/sneakers1/E1.jpg" alt="">
        <div class="small-img-groub">
            ...
            <div class="small-img-col">
                <img src="img/sneakers1/2.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/sneakers1/3.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Angelic stud earrings
        </h2>
        <h6>home/earrings</h6>
        <h3>$150.00</h3>
        <select class="my-3">
        ...
        <span>For a drop of dazzling crystals, choose these delicate studs. The rhodium plated design features a cool blue center stone surrounded by a circle of shimmering clear pavé. This versatile pair makes an ideal gift, and works for everyday wear or special occasions.</span>
    </div>
</div>
<div>
