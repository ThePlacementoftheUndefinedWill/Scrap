...
<div class="row mt-5">
    <div class="col-lg-5 col-md-12 col-12">
        <img class="img-fluid w-100 pb-1" src="img/sneakers2/E2.jpg" alt="">
        <div class="small-img-groub">
            ...
            <div class="small-img-col">
                <img src="img/sneakers2/2.webp" width="100%" class="small-img" alt="">
            </div>
    ...
    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Creativity Circle Pierced Earrings
        </h2>
        <h6>home/earrings</h6>
        <h3>$200.00</h3>
        <select class="my-3">
...
<span>Delicate circle silhouettes inject timeless elegance into any look, and this refined design adds a beautiful sparkle too. Rose gold-plated metal lends it a modern, feminine touch. Easy to combine with other Swarovski jewelry, the earrings come as a pair and measure 1 cm.</span>    </div>
</div>
<div>
