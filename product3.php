...
<div class="row mt-5">
    <div class="col-lg-5 col-md-12 col-12">
        <img class="img-fluid w-100 pb-1" src="img/T-shert3/R3.jpg" alt="">
        <div class="small-img-groub">
            ...
            <div class="small-img-col">
                <img src="img/T-shert3/Yellow2.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/T-shert3/coco1.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Constella ring
        </h2>
        <h6>home/Rings</h6>
        <h3>$550.00</h3>
        <select class="my-3">
        ...
        <span>Channel elegance with this rhodium plated ring from the Constella family. Inspired by fine jewelry techniques, this sophisticated design shines bright like the stars with round-cut stones and eye-catching pavé embellishment. Why not gift to yourself or a loved one?</span>
    </div>
</div>
<div>
