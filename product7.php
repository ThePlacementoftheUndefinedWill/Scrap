    ...
    <div class="col-lg-5 col-md-12 col-12">
        ...
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/sneakers3/1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/sneakers3/2.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/sneakers3/3.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/sneakers3/4.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Volta stud earrings
        </h2>
        <h6>home/sneakers</h6>
        <h3>$100.00</h3>
        <select class="my-3">
...
<span>These cute bow-inspired studs are an ideal way to bring more elegance to your look. Each rhodium plated piece is tied up in a ribbon design with an array of bright clear crystals set in place using the chattonage technique. A clear central stone provides the finishing touch. A wonderful romantic gift idea, these can be matched with a necklace from the Volta collection to harmonize your style.
</span>    </div>
</div>
<div>
