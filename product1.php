...
<div class="row mt-5">
    <div class="col-lg-5 col-md-12 col-12">
        <img class="img-fluid w-100 pb-1" src="img/T-shert1/R1.jpg" alt="">
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/T-shert1/T-shirtBlack.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/T-shert1/T-shirtBlack2.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/T-shert1/T-shirtWhite.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/T-shert1/T-shirtWhite2.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Vittore Pear Ring </h2>
        <h6>home/Rings</h6>
        <h3>$700.00</h3>
        <select class="my-3">
        ...
        <span>This ring by AM-Shop showcases the sparkling beauty of gleaming, faceted stones. White, drop-shaped elements arranged in a single row beautifully reflect and refract incoming light. Its pure, elegant forms make this ring perfect for combining with other pieces of jewellery, or for stacking with matching rings for an on-trend look. An excellent choice to enhance an outfit for special occasions, and a truly inspired gift giving idea.
        </span>
    </div>
</div>
<div>
