    ...
    <div class="col-lg-5 col-md-12 col-12">
        ...
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/watches2/1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches2/2.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches2/3.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches2/4.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Swarovski Infinity Heart Set
        </h2>
...
<span>Eternal love: This mixed metal finish jewelry set by AM-Shop combines romance and glamour. It consists of a pair of pierced earrings and a necklace. The earrings are shaped like infinity symbols, while the necklace features the same symbol intertwined with a heart. Each piece is set with white stones that gleam brilliantly whenever the light hits them. A single larger, brilliant white stone on each piece adds extra sparkle. This Swarovski set is the perfect gift for a romantic occasion.No returns or exchange applicable on earrings and sets.</span>
</div>
</section>
