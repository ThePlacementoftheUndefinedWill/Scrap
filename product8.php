...
<div class="row mt-5">
    <div class="col-lg-5 col-md-12 col-12">
        ...
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/sneakers4/E4.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/sneakers4/1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/sneakers4/2.webp" width="100%" class="small-img" alt="">
            </div>
    ...
    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Angelic Square Pierced Earrings
        </h2>
        <h6>home/sneakers</h6>
        <h3>$250.00</h3>
        <select class="my-3">
...
<span>Brighten up your jewelry box with this stunning pair of rhodium-plated pierced earrings with a sensual color injection. Showcasing square blue crystals framed with classic crystal pavé, the easy-to-wear design will still feel timeless in years to come. Perfect for gifting or an elegant choice for a wedding.
</span>    </div>
</div>
<div>
