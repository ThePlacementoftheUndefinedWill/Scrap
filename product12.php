    ...
    <div class="col-lg-5 col-md-12 col-12">
        ...
        <div class="small-img-groub">
            <div class="small-img-col">
                <img src="img/watches4/N4.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches4/1.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches4/2.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="img/watches4/3.webp" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>

    <div class="col-lg-5 col-md-12 col-12">
        <h2 class="py-4">Duo Moon Necklace
        </h2>
...
<span>The beauty of the moon and stars is stunningly captured in this coolly romantic rose gold-plated necklace. Dripping with crystal-laden symbolism in dark and light tones, this astronomically-inspired design feels both bohemian and luxurious. Perfect for layering with other necklaces in your collection, it can also be accessorized with the matching bracelet and ring.</span><div>
